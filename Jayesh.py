# -*- coding: utf-8 -*-
"""
Created on Sat Mar 30 00:54:28 2019
...
import random
root1=Tk()
L1=Label(root1,text="Choose the suitable option",bg="red",fg="yellow",font=14)
L1.pack()
root1.geometry("500x500")
root1.resizable(0,0)
b1=Radiobutton(root1,text="Player vs Player",value=1,width=25,height=10,font=("Helvetica", 16))
b1.pack()
b2=Radiobutton(root1,text="Player vs Computer",value=2,width=25,height=10,font=("Helvetica", 16))
b2.pack()
b1.pack()
b2.pack()
...
class MyApp(Tk):
    def __init__(self):
        ...
        self.player1_button = Button(self, text="Player 1",
                                    ...
                                    font=("Helvetica", 16))
        self.player2_button = Button(self, text="Player 2",
...
def but1():
    if __name__ == '__main__':
        root = MyApp()
        root.title("Jayesh's Tic Tac Toe")
        root.mainloop()
...
def but2():
    ...
    if __name__ == '__main__':
        root2 = MyApp2()
        root2.title("Jayesh's Tic Tac Toe")
        root2.mainloop()
